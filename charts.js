...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var samplenumber = samples.filter(sampleObject => parseInt(sampleObject.id) == sample);
    ...
    ///var topTenSlice = otu_id.slice(0,10);
    //var topTenReverse = topTenSlice.sort((a,b) => b-a)
    //var topTenCount = topTenReverse.map(otu_id => otu_id.sample_values);
